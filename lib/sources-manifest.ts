...
export const MAP_LAYERS: LayerInfo[] = [
  ...
  { label: 'FRONT', shows: 'Assessed frontline, Ukraine (occupied + grey zone)', source: 'DeepStateMap live map (open mirror as fallback)', cadence: 'several times a day' },
  { label: 'SIREN', shows: 'Air raid alerts per oblast, Ukraine', source: 'alerts.com.ua (official sirens)', cadence: '1 min' },

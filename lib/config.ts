...
export const RSS_FEEDS: FeedConfig[] = [
  ...
  { name: 'LRT (Lithuania)', url: 'https://www.lrt.lt/en/news-in-english?rss', category: 'europe', enabled: true, tier: 2, reliability: 82, region: 'europe' },
  { name: 'Notes from Poland', url: 'https://notesfrompoland.com/feed/', category: 'europe', enabled: true, tier: 2, reliability: 78, region: 'europe' },
  { name: 'Baltic News Network', url: 'https://bnn-news.com/feed', category: 'europe', enabled: true, tier: 3, reliability: 70, region: 'europe' },
  { name: 'YLE News (Finland)', url: 'https://feeds.yle.fi/uutiset/v1/recent.rss?publisherIds=YLE_NEWS', category: 'europe', enabled: true, tier: 2, reliability: 85, region: 'europe' },
  { name: 'The Local Germany', url: 'https://feeds.thelocal.com/rss/de', category: 'europe', enabled: true, tier: 3, reliability: 72, region: 'europe' },
  { name: 'The Local Denmark', url: 'https://feeds.thelocal.com/rss/dk', category: 'europe', enabled: true, tier: 3, reliability: 72, region: 'europe' },
  { name: 'The Local Sweden', url: 'https://feeds.thelocal.com/rss/se', category: 'europe', enabled: true, tier: 3, reliability: 72, region: 'europe' },
  { name: 'Google News: Europe drones', url: 'https://news.google.com/rss/search?q=(drone%20OR%20drones)%20(airport%20OR%20airspace%20OR%20%22military%20base%22)%20(closed%20OR%20suspended%20OR%20sighting%20OR%20violated%20OR%20incursion)%20(Germany%20OR%20Poland%20OR%20Denmark%20OR%20Lithuania%20OR%20Latvia%20OR%20Estonia%20OR%20Norway%20OR%20Sweden%20OR%20Finland%20OR%20Netherlands%20OR%20Belgium%20OR%20Romania)%20when:2d&hl=en&gl=US&ceid=US:en', category: 'europe', enabled: true, tier: 3, reliability: 65, region: 'europe' },
  { name: 'Google News DE: Drohnen', url: 'https://news.google.com/rss/search?q=(Drohne%20OR%20Drohnen%20OR%20Drohnensichtung)%20(Flughafen%20OR%20Bundeswehr%20OR%20Kaserne%20OR%20Luftraum)%20(gesperrt%20OR%20Sichtung%20OR%20gesichtet%20OR%20eingestellt)%20-Ukraine%20-Kiew%20when:2d&hl=de&gl=DE&ceid=DE:de', category: 'europe', enabled: true, tier: 3, reliability: 65, region: 'europe' },
...
export const CONFLICT_KEYWORDS = [
  ...
  'drone', 'drones', 'airspace', 'sabotage', 'jamming', 'Drohne', 'Drohnen', 'UAV', 'ground operation', 'nuclear', 'submarine',
...
export const LOCATION_MAP: Record<string, { lat: number; lng: number; country: string }> = {
  ...
  // NAVO-oostflank (14 sep 2026): grensplaatsen en samengestelde sleutels, zodat "strikes near Polish border" niet op midden-Oekraïne of Siberië landt
  'polish border': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'poland border': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'border with poland': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'ukraine-poland border': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'poland-ukraine border': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'polish-ukrainian border': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'ukrainian-polish border': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'border crossings with ukraine': { lat: 50.20, lng: 23.40, country: 'Poland' },
  'medyka': { lat: 49.8050, lng: 22.9330, country: 'Poland' },
  'dorohusk': { lat: 51.1700, lng: 23.8000, country: 'Poland' },
  'hrebenne': { lat: 50.2500, lng: 23.4700, country: 'Poland' },
  'przemysl': { lat: 49.7838, lng: 22.7678, country: 'Poland' },
  'przemyśl': { lat: 49.7838, lng: 22.7678, country: 'Poland' },
  'rzeszow': { lat: 50.0413, lng: 21.9990, country: 'Poland' },
  'rzeszów': { lat: 50.0413, lng: 21.9990, country: 'Poland' },
  'lublin': { lat: 51.2465, lng: 22.5684, country: 'Poland' },
  'warsaw': { lat: 52.2297, lng: 21.0122, country: 'Poland' },
  'suwalki': { lat: 54.1115, lng: 22.9308, country: 'Poland' },
  'suwałki': { lat: 54.1115, lng: 22.9308, country: 'Poland' },
  ...
  'kaliningrad': { lat: 54.7104, lng: 20.4522, country: 'Russia' },
...
export const SITUATIONS: AnchorSituation[] = [
  // 19 sep 2026 (Leander): drones en luchtruimincidenten boven NAVO-gebied zijn wél breaking nieuws (luchtalarm in Oekraïne is ruis).
  // Staat vooraan omdat de eerste match wint; 'exclude' houdt het oorlogsnieuws uit Oekraïne, Rusland en het Midden-Oosten erbuiten.
  { id: 'eu-airspace', slug: 'europe-airspace-drones', title: 'Europe Airspace / Drones', type: 'conflict',
    anchorKeywords: ['drone sighting','drone sightings','drones spotted','drone spotted','drones sighted','drone sighted','unidentified drones','unidentified drone','mystery drones','suspicious drones','drone incursion','drone incursions','drone alert','drones over','drone over','drone found','drone crashes','drone crashed','airspace violation','airspace violations','violated airspace','violates airspace','violating airspace','airspace closed','closes airspace','airport closed','airport shut','airport shuts','airport suspends','flights suspended','flights halted','gps jamming','hybrid attack','hybrid attacks','hybrid warfare','sabotage','undersea cable','subsea cable','cable cut','shadow fleet','drohnensichtung','drohnensichtungen','drohnenalarm','drohnen über','drohne über','drohnen gesichtet','flughafen gesperrt'],
    exclude: 'ukrain|kyiv|kiev|kharkiv|odesa|odessa|dnipro|zaporizh|lviv|kherson|sumy|donetsk|crimea|belgorod|moscow|kursk|kremlin|russian region|in russia|gaza|israel|iran|houthi|yemen|sudan|lebanon|syria|iraq|red sea|hormuz|taiwan|korea|india|pakistan|africa|far east|siberia|russian election|election commission|drone show|light show|delivery|start-?up|funding|contract|procure|\\bbuys?\\b|purchase|export|manufactur|drone maker|shares|stocks?\\b',
    // vaste woordgroepen misten 'drone activity' en 'Drohnen legen … lahm' (Luxemburg, 19 sep): elk drone-/luchtruimwoord telt, mits de kop Europa noemt (requireAny) en niet is uitgesloten
    anchorRegex: '\\b(drones?|drohnen?|uavs?|unmanned aircraft|airspace|luftraum|gps jamming|gps interference|hybrid attacks?|hybrid warfare|undersea cables?|subsea cables?|shadow fleet)\\b',
    // de kop moet Europa noemen: 'sabotage' alleen ving ook een TASS-bericht over het Russische Verre Oosten (19 sep)
    requireAny: '\\b(german\\w*|poland|polish|denmark|danish|norw\\w+|swed\\w+|finland|finnish|estonia\\w*|latvia\\w*|lithuania\\w*|baltic|nordic|netherlands|dutch|belgi\\w+|luxemb\\w+|swiss|switzerland|france|french|romania\\w*|bulgaria\\w*|czech\\w*|slovak\\w*|hungar\\w+|austria\\w*|ital\\w+|spain|spanish|portug\\w+|ireland|irish|britain|british|uk|nato|eu|europe\\w*|airports?|munich|berlin|frankfurt|hamburg|leipzig|copenhagen|oslo|stockholm|helsinki|warsaw|vilnius|riga|tallinn|brussels|amsterdam|schiphol|bundeswehr|north sea|flughafen|luftraum|kaserne|deutschland)\\b',
    center: { lat: 53.0, lng: 14.0 }, bbox: [46.0, 3.0, 61.0, 28.0], zoom: 4, actors: ['NATO', 'EU', 'Russia (suspected)'], coversRegion: false },
  ...
  { id: 'nato-east', slug: 'nato-eastern-flank', title: 'NATO Eastern Flank / Poland', type: 'conflict', anchorKeywords: ['Poland','Polish','Polish border','Warsaw','Rzeszów','Rzeszow','Medyka','Lublin','Lithuania','Vilnius','Suwałki','Suwalki','Estonia','Latvia','Kaliningrad','eastern flank','Article 4','Article 5'], center: { lat: 51.5, lng: 22.5 }, bbox: [48.5,14.0,59.0,28.5], zoom: 5, actors: ['NATO','Poland','Russia','Belarus'] },

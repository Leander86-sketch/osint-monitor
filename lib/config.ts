...
export const SITUATIONS: AnchorSituation[] = [
  ...
  { id: 'iran-israel', slug: 'iran-israel', title: 'Iran-Israel', type: 'conflict', anchorKeywords: ['Iran','Israel','Tel Aviv','Natanz','enrichment','uranium','Isfahan','Tehran','ballistic missile'], center: { lat: 32.0, lng: 45.0 }, bbox: [28.0,34.0,37.0,54.0], zoom: 5, actors: ['Iran','Israel','IRGC'] },
